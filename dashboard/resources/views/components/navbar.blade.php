<nav class="bg-gray-800" x-data="{ isOpen: false }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center">
            <div class="shrink-0">
            <img class="size-8" src="img/logo.png" style="width : 60px; height: 60px" alt="Your Company">
            </div>
        ...
        <div class="hidden md:block">
            ...
            <div class="relative ml-3">
                ...
                <button type="button" @click="isOpen = !isOpen" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <img class="size-8 rounded-full" src="img/user.png" alt="">
                </button>
                </div>
        ...
        <div class="-mr-2 flex md:hidden">
            ...
            <svg :class="{'hidden': isOpen, 'bloc': !isOpen }"
            ...
            <svg :class="{'bloc': isOpen, 'hidden': !isOpen }"
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            <x-nav-link href="/" :active="request()->is('/')">Home</x-nav-link>
            <x-nav-link href="/schedule" :active="request()->is('schedule')">Schedule</x-nav-link>
            <x-nav-link href="/inventory" :active="request()->is('inventory')">Inventory</x-nav-link></div>
        ...
        <div class="flex items-center px-5">
            ...
            <div class="text-sm font-medium text-gray-400">userEmail@email.com</div>
            </div>
            <button type="button"
